...
// ***********************************Location Fetching*************************************
 ...
 Future<void> getlocations() async {
      try {
        final response = await http.get(Uri.parse('http://192.168.3.168:4000/locations'));
...
Future<void> getdepartments(String locationid) async {
  try {
    final response = await http.get(Uri.parse('http://192.168.3.168:4000/departments?locationid=$locationid'));
...
Future<void> login() async {
  ...
  try {
    final response = await http.post(
      Uri.parse('http://192.168.3.168:4000/applogin'),
